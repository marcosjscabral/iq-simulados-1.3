        ...
        <div className="bg-slate-50 min-h-screen text-slate-900 font-sans">
            <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
                <div className="flex items-center p-4 justify-between pt-12 max-w-5xl mx-auto">
                    <button onClick={() => navigate('/profile')} className="size-10 flex items-center justify-start text-slate-900 hover:text-slate-700 transition-colors">
                        <ChevronLeft size={24} />
                    </button>
                    <div className="flex flex-col items-center">
                        <h1 className="text-xl font-black leading-tight text-slate-900 uppercase italic tracking-tighter">Meus Pedidos</h1>
                        <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold">Histórico de Compras</p>
                    </div>
                        ...
                        {purchases.map((purchase) => (
                            ...
                            >
                                <div className="w-full sm:w-48 h-32 sm:h-auto shrink-0 bg-slate-100 relative overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4 bg-emerald-500 text-white text-[9px] font-black uppercase tracking-widest px-2.5 py-1.5 rounded-full shadow-sm">
                                        Pedido Concluído
                                    </div>
                                </div>
                                ...
                                <div className="p-6 flex flex-col justify-between flex-1">
                                    <div>
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                                            <h3 className="text-lg font-black text-slate-900 leading-tight uppercase tracking-tight italic">
