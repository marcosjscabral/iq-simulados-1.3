...
export default function CheckoutSuccess() {
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-slate-900 text-center">
                <div className="size-20 bg-red-100 text-red-600 rounded-xl flex items-center justify-center mb-6">
                    <Home size={40} />
                </div>
                ...
                <button
                    onClick={() => navigate('/')}
                    className="bg-white text-slate-900 px-8 py-4 rounded-lg font-black uppercase italic tracking-widest border border-slate-200 shadow-sm"
                >
                    Voltar para Início
                </button>
            </div>
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-slate-900 text-center">
            <div className="size-24 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center mb-8 shadow-sm">
            ...
            <div className="bg-white p-8 rounded-xl border border-slate-200 mb-12 w-full max-w-md mx-auto shadow-sm">
            ...
            <div className="flex flex-col gap-4 w-full max-w-md">
                <button
                    ...
                    className="bg-slate-900 text-white font-black py-5 rounded-lg flex items-center justify-center gap-3 active:scale-95 transition-all shadow-sm uppercase tracking-widest italic"
                >
