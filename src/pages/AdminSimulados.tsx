...
import { ArrowLeft, Plus, Camera, Image as ImageIcon } from 'lucide-react';
        ...
        <header className="bg-yellow-400 p-6 pt-12 pb-8 rounded-b-[2rem] shadow-md">
          <div className="flex items-center gap-4">
            <button
              ...
              className="bg-white/20 hover:bg-white/40 p-2 rounded-full backdrop-blur-sm transition-colors text-slate-900"
            >
              <ArrowLeft size={24} />
            </button>
            <div>
        ...
        <main className="flex-1 px-4 -mt-4 space-y-6 pb-12">
          ...
          <section className="bg-white dark:bg-slate-800 rounded-xl p-4 border-2 border-dashed border-blue-600/30 shadow-sm">
            <div className="flex flex-col items-center justify-center py-6 gap-2">
              ...
              <button className="mt-2 text-blue-600 text-sm font-bold border border-blue-600 px-4 py-2 rounded-lg flex items-center gap-2">
